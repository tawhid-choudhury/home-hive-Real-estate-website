...
const AgentPropertiesCard = ({ item, refetch }) => {
        ...
        <div>
            <Box sx={{ p: 2, border: 1, mb: 4, borderRadius: 2, borderColor: "gray", display: 'flex', alignItems: 'center', justifyContent: "space-between", gap: 2, }}>
                ...
                <Box>
                    ...
                    <Typography variant='subtitle1'>
                        Varification Status: {item?.verificationStatus}
                    </Typography>
                ...
                <Box>
                    <Link to={`/dashboard/update/${item._id}`}><Button sx={{ my: 2 }} variant='contained' color='primary' > Update</Button></Link>
                    <br />
